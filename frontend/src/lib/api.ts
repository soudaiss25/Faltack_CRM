...
/**
 * Petit wrapper autour de fetch : ajoute automatiquement le token JWT
 * (stocké en localStorage après connexion) sur chaque appel protégé,
 * pour ne pas avoir à le refaire manuellement dans chaque composant.
 */
